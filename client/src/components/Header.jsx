    ...
    <header className="mx-auto flex max-w-2xl items-center justify-between px-6 pt-10 pb-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="flex h-9 w-9 items-center justify-center rounded-full border border-ink-200 bg-white text-ink-500 hover:text-ink-900 transition-colors dark:border-ink-800 dark:bg-ink-800 dark:text-ink-400 dark:hover:text-ink-50"
        >
